...
<template>
  <div>
    <v-row>
      <v-col cols="12">
        <h1 class="text-h4 mb-4">داشبورد مدیریت</h1>
        <v-sheet color="surface" elevation="1" class="pa-4 mb-4" rounded>
          <div class="text-h6">خوش آمدید، {{ username }}</div>
    ...
    <v-row>
      <v-col v-if="loading" cols="12" class="text-center py-10">
        ...
        <div class="text-body-1 mt-4">در حال بارگذاری...</div>
      </v-col>
      ...
      <template v-else>
        ...
        <v-col cols="12" md="4">
          <v-card elevation="2" class="mb-4 pa-4">
            ...
            <div class="text-h3 font-weight-bold text-primary">{{ stats.todayTrips }}</div>
            <div class="mt-2">از {{ stats.totalTrips }} سفر کل</div>
          </v-card>
        </v-col>
        ...
        <v-col cols="12" md="4">
          <v-card elevation="2" class="mb-4 pa-4">
            ...
            <div class="text-h3 font-weight-bold text-warning">{{ stats.canceledTrips }}</div>
            <div class="mt-2">در 24 ساعت گذشته</div>
          </v-card>
        </v-col>
        ...
        <v-col cols="12" md="4">
          <v-card elevation="2" class="mb-4 pa-4">
            ...
            <div class="text-h3 font-weight-bold text-success">{{ stats.activeBuses }}</div>
            <div class="mt-2">از {{ stats.totalBuses }} اتوبوس</div>
          </v-card>
        </v-col>
